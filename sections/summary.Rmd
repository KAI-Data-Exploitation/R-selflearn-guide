...
* `stas` - perfrom unsupervised learning (preloaded package).


#### Making forecasts

* `forecast` - perfrom forecasts and manipulate time series.
...
* `shiny` - produce dashboards that can run any R code but needs to be hosted.
