...
* Either reading the book [R for Data Science](http://r4ds.had.co.nz/)
* Or obtaining a licence for [DataCamp](https://www.datacamp.com) and following the *Data Scientist with R* career track

There is also a [good style guide](http://style.tidyverse.org/) which we would recommend as the best approach to formatting your R code for clarity and consistency.
